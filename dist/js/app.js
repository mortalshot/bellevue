    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu__icon")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".menu__icon")) document.documentElement.classList.toggle("menu-open");
            }));
        }
        function menuClose() {
            bodyUnlock();
        ...
        if (document.querySelector("#checkin") && document.querySelector("#checkout")) {
            ...
            const checkin = datepicker_min("#checkin", {
                startDay: 1,
            ...
            modules_flsModules.datepicker = checkout;
            modules_flsModules.datepicker = checkin;
        }
        if (document.querySelector("#booking-date")) {
            const bookingDate = datepicker_min("#booking-date", {
                startDay: 1,
                dateSelected: nextDay,
                minDate: new Date,
                formatter: (input, date, instance) => {
            ...
            modules_flsModules.datepicker = bookingDate;
        }
        ...
        function initSliders() {
            if (document.querySelector(".firstscreen__slider")) new swiper_core_Swiper(".firstscreen__slider", {
            ...
            if (document.querySelector(".special-offers__slider")) new swiper_core_Swiper(".special-offers__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".rooms-suites__slider")) new swiper_core_Swiper(".rooms-suites__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".features-tabs__slider")) new swiper_core_Swiper(".features-tabs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".additional__slider")) new swiper_core_Swiper(".additional__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.33,
            ...
            if (document.querySelector(".room-popup__slider")) new swiper_core_Swiper(".room-popup__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".widget-blog__slider")) new swiper_core_Swiper(".widget-blog__slider", {
            ...
            if (document.querySelector(".family__slider")) {
                ...
                window.addEventListener("resize", (function() {
                    if (currentWidth < 834 && window.innerWidth >= 834 || currentWidth >= 834 && window.innerWidth < 834) location.reload();
                }));
                if (window.innerWidth <= 834) new swiper_core_Swiper(".family__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
...
***************************************************************************** */
        ...
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".datepicker")) targetElement.closest(".datepicker").classList.add("_active");
            if (!targetElement.closest(".datepicker") && document.querySelectorAll(".datepicker._active").length > 0) removeClasses(document.querySelectorAll(".datepicker._active"), "_active");
            ...
            if (document.querySelector(".checkin-widget") && !targetElement.closest(".checkin-widget")) document.querySelector(".checkin-widget").classList.remove("_active");
        }));
        ...
        if (above) {
            ...
            window.addEventListener("scroll", (function(e) {
                ...
                if (scrollTop > 1e3 && scrollTop < scrollDirection) above.classList.add("_show"); else above.classList.remove("_show");
